        ...
        <div class="page-title-wrapper">
            <h1 class="page-title" id="page-title-heading" aria-labelledby="page-title-heading toolbar-amount">
                <span class="base" data-ui-id="page-title-wrapper"><span
                            class="first-word"> Car </span> wash machines</span></h1>
        </div>
        <div class="category-description">
            <div data-content-type="row" data-appearance="contained" data-element="main">
                <div data-enable-parallax="0" data-parallax-speed="0.5" data-background-images="{}" data-element="inner"
                     style="justify-content: flex-start; display: flex; flex-direction: column;
                     background-position: left top; bottom: ;ackground-size: cover; background-repeat: no-repeat;
                     background-attachment: scroll; border-style: none; border-width: 1px; border-radius: 0px;
                     margin: 0px 0px 10px; padding: 10px;">
                    <div data-content-type="html" data-appearance="default" data-element="main"
                         style="border-style: none; border-width: 1px; border-radius: 0px; margin: 0px; padding: 0px;">
                        <p><span style="font-size: large;">Get to know the wide range of ISTOBAL vehicle washes for all types of vehicles. State-of-the-art solutions for &nbsp;automatic car wash and tunnels or jet wash centres. Maximum technology and reliability to increase the profitability of your car wash business.</span>
                        </p></div>
                </div>
            </div>
        </div>
